...
setup1<-nnetar(IndiaGDP_ts[1:40], p=12, repeats=20, lambda="auto")
...
plugin.forecast <- gdp2023.residual*ARMA1$coef[1] + ARMA1$coef[2] + ARMA1$coef[3] + ARMA1$coef[4] + ARMA1$coef[5] + ARMA1$coef[6] + ARMA1$coef[7] + ARMA1$coef[8] + ARMA1$coef[9]
print(plugin.forecast)
```

```{r}
gdp2023.residual <- window(Mod4$residuals, start = c(1980), end = c(2019))
